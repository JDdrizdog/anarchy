    ...
    public class Aes256
    {
        ...
        public byte[] Encrypt(byte[] input)
        {
            ...
            using (AesCryptoServiceProvider aesCryptoServiceProvider = new AesCryptoServiceProvider())
            {
                ...
                byte[] array;
                array = hMACSHA.ComputeHash(memoryStream.ToArray(), 32, memoryStream.ToArray().Length - 32);
        ...
        public byte[] Decrypt(byte[] input)
        {
            ...
            {
                byte[] a;
                a = hMACSHA.ComputeHash(memoryStream.ToArray(), 32, memoryStream.ToArray().Length - 32);
                byte[] array;
                array = new byte[32];
            ...
            byte[] array3;
            array3 = new byte[memoryStream.Length - 16L + 1L];
            byte[] array4;
            array4 = new byte[cryptoStream.Read(array3, 0, array3.Length)];
